...
int main() {
    ...
    std::cout << mySet.getRandom() << std::endl;
    std::cout << mySet.getRandom() << std::endl;std::cout << mySet.getRandom() << std::endl;std::cout << mySet.getRandom() << std::endl;std::cout << mySet.getRandom() << std::endl;std::cout << mySet.getRandom() << std::endl;std::cout << mySet.getRandom() << std::endl;std::cout << mySet.getRandom() << std::endl;std::cout << mySet.getRandom() << std::endl;std::cout << mySet.getRandom() << std::endl;std::cout << mySet.getRandom() << std::endl;std::cout << mySet.getRandom() << std::endl;std::cout << mySet.getRandom() << std::endl;std::cout << mySet.getRandom() << std::endl;
